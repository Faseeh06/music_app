          ...
          <div className="w-full max-w-md mx-auto">
            <div className="bg-gray-900/20 backdrop-blur-sm border border-gray-800/50 rounded-2xl p-8 shadow-2xl">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-400">今日から音楽の旅を始めましょう</p>
              </div>
              ...
              <p className="text-xs text-gray-500 text-center mb-6">
                ...
                <button className="text-brand-brown hover:underline">利用規約</button>
                {' '}and{' '}
                <button className="text-brand-brown hover:underline">プライバシーポリシー</button>
              </p>
